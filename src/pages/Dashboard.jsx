    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-gradient-to-r from-indigo-900/40 to-slate-900 border border-indigo-500/20 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-300 max-w-2xl leading-relaxed">
            ...
            <strong>Gelombang 1</strong>, misi utama kita adalah mengumpulkan
            data lapangan, memetakan masalah sespesifik mungkin, lalu
            menyerahkannya ke Kelompok Riset secara terstruktur.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h3 className="font-bold text-white flex items-center gap-2">
              <AlertTriangle className="h-5 w-5 text-rose-500" /> Temuan Masalah
              Terakhir
            </h3>
            <button
              onClick={() => setCurrentTab("problems")}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h3 className="font-bold text-white flex items-center gap-2">
              <CheckSquareIcon className="h-5 w-5 text-amber-500" /> Monitoring
              Tugas Aktif
            </h3>
            <button
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
        <h3 className="font-bold text-white flex items-center gap-2">
          <MapPin className="h-5 w-5 text-indigo-400" /> Ekosistem & Tautan
          Pintar Kelompok
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl hover:border-slate-700 transition-all space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Tempat tim Medok kolaborasi menyusun template postingan Instagram
              ber-palet <strong>Sage Green / Navy</strong>.
            </p>
            <a
              href="#"
              className="text-xs text-indigo-400 flex items-center gap-1 hover:underline pt-2"
          ...
          <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl hover:border-slate-700 transition-all space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Peta koordinat pusat kantor balai desa agar rute tim Humas dan tim
